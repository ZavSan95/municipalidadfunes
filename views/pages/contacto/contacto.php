                ...
                <div class="position-sticky top-120px lg-top-0px lg-position-relative text-center text-xl-start">
                    <span
                        class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex justify-content-center justify-content-xl-start"><i
                            class="bi bi-chat-square-dots fs-16 me-5px"></i>¡Trabajemos Juntos!</span>
                    <h3 class="text-dark-gray ls-minus-2px fw-700">Te dejamos la ubicación de todas nuestras dependencias.
                    </h3>
                    <p class="mb-35px w-90 lg-w-100 sm-mb-25px"></p>
                </div>
            </div>
                ...
                <div class="row row-cols-1 justify-content-center"
                        ...
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            <div class="col-lg-6 col-sm-6">
                                <div class="h-100 cover-background xs-h-300px"
                                    style="background-image: url(<?php echo $path ?>/views/assets/images/dependencias/municipalidad.jpeg)"></div>
                            </div>
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-40px xl-p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray primary-font fw-700 fs-19 mb-10px">Edificio Municipal</span>
                                    <p>Santa Fe 1689</p>
                                    <a href="https://maps.app.goo.gl/HkqH8gbExr5EMcab9" target="_blank"
                                        class="fs-16 lh-20 primary-font fw-500 text-dark-gray text-decoration-line-bottom d-inline-block mb-25px">Encontralo aquí</a>
                                    <div class="text-dark-gray fw-600"><i
                                            class="feather icon-feather-phone-call icon-small me-10px text-dark-gray"></i><a
                                            href="tel:12345678910">493-6000</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col services-box-style-02 mb-30px">
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            <div class="col-lg-6 col-sm-6">
                                <div class="h-100 cover-background xs-h-300px"
                                    style="background-image: url(<?php echo $path ?>/views/assets/images/dependencias/tribunal.jpg)"></div>
                            </div>
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-40px xl-p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray primary-font fw-700 fs-19 mb-10px">Tribunal de Faltas</span>
                                    <p>Moreno 1420</p>
                                    <a href="https://maps.app.goo.gl/M8jxrAJJRb8ATFKv5" target="_blank"
                                        class="fs-16 lh-20 primary-font fw-500 text-dark-gray text-decoration-line-bottom d-inline-block mb-25px">Encontralo aquí</a>
                                    <div class="text-dark-gray fw-600"><i
                                            class="feather icon-feather-phone-call icon-small me-10px text-dark-gray"></i><a
                                            href="tel:12345678910">4936014</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col services-box-style-02 mb-30px">
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            <div class="col-lg-6 col-sm-6">
                                <div class="h-100 cover-background xs-h-300px"
                                    style="background-image: url(<?php echo $path ?>/views/assets/images/dependencias/obrador.jpeg)"></div>
                            </div>
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-40px xl-p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray primary-font fw-700 fs-19 mb-10px">Obrador Municipal</span>
                                    <p>Av. Fuerza Aerea e Hipólito Yrigoyen</p>
                                    <a href="https://maps.app.goo.gl/CUdZSdzfSoAzJttx9" target="_blank"
                                        class="fs-16 lh-20 primary-font fw-500 text-dark-gray text-decoration-line-bottom d-inline-block mb-25px">Encontralo aquí</a>
                                    <div class="text-dark-gray fw-600"><i
                                            class="feather icon-feather-phone-call icon-small me-10px text-dark-gray"></i><a
                                            href="tel:12345678910"></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col services-box-style-02 md-mb-30px">
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            <div class="col-lg-6 col-sm-6">
                                <div class="h-100 cover-background xs-h-300px"
                                    style="background-image: url(<?php echo $path ?>/views/assets/images/dependencias/polideportivo.jpg)"></div>
                            </div>
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-40px xl-p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray primary-font fw-700 fs-19 mb-10px">Polideportivo Municipal</span>
                                    <p>Buenos Aires 1502</p>
                                    <a href="https://maps.app.goo.gl/qBxhbxphLXzKVx5PA"
                                        class="fs-16 lh-20 primary-font fw-500 text-dark-gray text-decoration-line-bottom d-inline-block mb-25px">Encontralo aquí</a>
                                    <div class="text-dark-gray fw-600"><i
                                            class="feather icon-feather-phone-call icon-small me-10px text-dark-gray"></i><a
                                            href="tel:12345678910"></a></div>
    ...
    <div class="container">
        <div class="row mb-8">
                ...
                <div class="bg-white border-radius-6px box-shadow-quadruple-large p-10 ps-12 pe-12 lg-ps-8 lg-pe-8 h-100 d-flex flex-wrap flex-column justify-content-center"
                    ...
                    <span
                        class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex align-self-start"><i
                            class="bi bi-chat-square-dots fs-16 me-5px"></i>¡Estamos a disposición!</span>
                    <h4 class="text-dark-gray ls-minus-1px fw-700 mb-15px">Listos para resolver tus problemas.</h4>
                    <p class="w-85 sm-w-100">Estamos en contacto para poder atender todas tus inquietudes.</p>
                    <div class="row row-cols-1 row-cols-sm-2">
                        <div class="col last-paragraph-no-margin mb-25px">
                            <p>Mesa de Entradas</p>
                            <a href="tel:12345678910" class="text-dark-gray fw-600">493-6000</a>
                        </div>
                        <div class="col last-paragraph-no-margin mb-25px">
                            <p>Correo Electrónico</p>
                            <a href="mailto:info@domain.com" class="text-dark-gray fw-600">info@funes.com.ar</a>
                        </div>
                        <div class="col last-paragraph-no-margin sm-mb-25px">
                            <p>Reclamos</p>
                            <a href="https://w.app/reclamosfunes" class="text-dark-gray fw-600">341-xxxxxxx</a>
                        </div>
            ...
            <div class="col-lg-6 offset-xl-1 md-mb-50px sm-mb-0"
                data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                <h3 class="text-dark-gray ls-minus-2px fw-700">¿Necesitas más ayuda?</h3>
                <form action="email-templates/contact-form.php" method="post" class="contact-form-style-03">
                    <label for="exampleInputEmail1"
                        class="form-label fs-13 text-uppercase text-dark-gray fw-700 mb-0">Ingresa tu nombre*</label>
                    <div class="position-relative form-group mb-20px">
                        ...
                        <input
                            ...
                            id="exampleInputEmail1" type="text" name="name" placeholder="Nombre" />
                    </div>
                    <label for="exampleInputEmail1"
                        class="form-label fs-13 text-uppercase text-dark-gray fw-700 mb-0">Ingresa tu correo electrónico*</label>
                    <div class="position-relative form-group mb-20px">
                        <span class="form-icon"><i class="bi bi-envelope text-dark-gray"></i></span>
                        <input
                            class="fs-15 ps-0 border-radius-0px border-color-dark-gray bg-transparent form-control required"
                            id="exampleInputEmail2" type="email" name="email" placeholder="Correo Electrónico" />
                    </div>
                    <label for="exampleInputEmail1"
                        class="form-label fs-13 text-uppercase text-dark-gray fw-700 mb-0">Ingresa tu mensaje</label>
                    <div class="position-relative form-group form-textarea mb-0">
                        <textarea
                            class="fs-15 ps-0 border-radius-0px border-color-dark-gray bg-transparent form-control"
                            name="comment" placeholder="Describinos tu inquietud" rows="3"></textarea>
                    ...
                    <div class="row mt-25px align-items-center">
                        <div class="col-xl-7 col-lg-12 col-sm-7 lg-mb-30px md-mb-0">
                            <p class="mb-0 fs-14 lh-22 text-center text-sm-start"></p>
                        </div>
                        <div
                            ...
                            <button class="btn btn-dark-gray btn-medium btn-round-edge btn-box-shadow submit"
