                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <label for="title_new">Título <sup class="text-danger font-weight-bold">*</sup></label>

                                        <input type="text" class="form-control required"
                                            placeholder="Ingresar el título" id="title_new" name="title_new"
                                            value="<?php if (!empty($new)): ?><?php echo $new->title_new ?><?php endif ?>"
                                            required>
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <label for="category_new">Categoría <sup class="text-danger font-weight-bold">*</sup></label>

                                        <input type="text" class="form-control required"
                                            placeholder="Ingresar la categoría" id="category_new" name="category_new"
                                            value="<?php if (!empty($new)): ?><?php echo $new->category_new ?><?php endif ?>"
                                            required>
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <textarea class="form-control" id="intro_new" name="intro_new"
                                            ...
                                            value="<?php if (!empty($new)): ?><?php echo $new->intro_new ?><?php endif ?>"
                                            ></textarea>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-3">
                                        ...
                                        <label for="body_new">Cuerpo <sup class="text-danger font-weight-bold">*</sup></label>

                                        <textarea class="form-control required" id="body_new" name="body_new"
                                                placeholder="Ingresar el cuerpo del artículo"
                                                required>
                                            <?php if (!empty($new)): ?>
                                                <?php echo htmlspecialchars($new->body_new); ?>
                                            <?php endif; ?>
                                        </textarea>
