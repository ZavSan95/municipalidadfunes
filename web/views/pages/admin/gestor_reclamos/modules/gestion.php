...
<div class="content">
    ...
    <div class="accordion-item">
        ...
        <div id="collapsePersonalData" class="accordion-collapse collapse show" aria-labelledby="headingPersonalData" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <div class="row">

                    <div class="col-md-12">
                        <label for="id_estado_reclamo">Estado <sup class="text-danger font-weight-bold">*</sup></label>
                        <select name="id_estado_reclamo" class="form-control required">
                            <option value="" <?php if (!empty($reclamo) && $reclamo->id_estado_reclamo == ""): ?> selected <?php endif ?>>Seleccione Estado</option>
                            <?php 
                    ...
                    <div class="col-md-12 mt-3">
                        <label for="id_rcategory_reclamo">Categoría <sup class="text-danger font-weight-bold">*</sup></label>
                        <select name="id_rcategory_reclamo" class="form-control required">
                            <option value="" <?php if (!empty($reclamo) && $reclamo->id_rcategory_reclamo == ""): ?> selected <?php endif ?>>Seleccione Categoría</option>
                            <?php 
                    ...
                    <div class="col-md-12 mt-3">
                        <label for="img_reclamo">Imágenes <sup class="text-danger font-weight-bold">*</sup></label>
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="form-group pb-3 text-center">
                                    <div class="dropzone mb-16px" id="myDropzoneReclamo">
                                        <!-- Contenido de Dropzone -->
                                    </div>
                                    <input type="hidden" name="imageReclamo" class="galleryReclamo">
                                </div>
                            </div>
                        </div>   
                    </div>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="headingPropertyData">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePropertyData" aria-expanded="false" aria-controls="collapsePropertyData">
                Datos Inmueble
            </button>
        </h2>
        <div id="collapsePropertyData" class="accordion-collapse collapse" aria-labelledby="headingPropertyData" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group pb-3">
                            <label for="cuenta_reclamo">Cuenta</label>
                            <input type="text" class="form-control" id="cuenta_reclamo" name="cuenta_reclamo" placeholder="Ingresar la cuenta" value="<?php echo !empty($reclamo) ? $reclamo->cuenta_reclamo : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group pb-3">
                            <label for="deuda_reclamo">Deuda</label>
                            <input type="text" class="form-control" id="deuda_reclamo" name="deuda_reclamo" placeholder="Ingresar la deuda" value="<?php echo !empty($reclamo) ? $reclamo->deuda_reclamo : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="id_zona_reclamo">Zona <sup class="text-danger font-weight-bold">*</sup></label>
                        <select name="id_zona_reclamo" class="form-control required">
                            <option value="" <?php if (!empty($reclamo) && $reclamo->id_zona_reclamo == ""): ?> selected <?php endif ?>>Seleccione Categoría</option>
                            <?php 
                    ...
                    <div class="col-md-6">
                        <div class="form-group pb-3">
                            ...
                            <input type="text" id="direccion" class="form-control required" name="direccion_reclamo" value="<?php echo !empty($reclamo) ? $reclamo->direccion_reclamo : ''; ?>" required placeholder="Dirección*">
                        </div>
                    </div>
                    <div id="map-container" class="col-md-12">
                        <iframe id="map-iframe" width="100%" height="400px" frameborder="0" style="border:0" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAaRnCKVVSWGR159MyTF6rV7NMIPsW960c&q=Funes,Argentina"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="headingClaimData">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseClaimData" aria-expanded="false" aria-controls="collapseClaimData">
                Datos Personales
            </button>
        </h2>
        <div id="collapseClaimData" class="accordion-collapse collapse" aria-labelledby="headingClaimData" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                            <div class="form-group pb-3">
                                ...
                                <input type="text" class="form-control" id="nombre_reclamo" name="nombre_reclamo" placeholder="Ingresar el nombre" value="<?php echo !empty($reclamo) ? $reclamo->nombre_reclamo : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group pb-3">
                                <label for="apellido_reclamo">Apellido</label>
                                <input type="text" class="form-control" id="apellido_reclamo" name="apellido_reclamo" placeholder="Ingresar el apellido" value="<?php echo !empty($reclamo) ? $reclamo->apellido_reclamo : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group pb-3">
                                <label for="dni_reclamo">DNI</label>
                                <input type="text" class="form-control" id="dni_reclamo" name="dni_reclamo" placeholder="Ingresar el DNI" value="<?php echo !empty($reclamo) ? $reclamo->dni_reclamo : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group pb-3">
                                <label for="celular_reclamo">Celular</label>
                                <input type="text" class="form-control" id="celular_reclamo" name="celular_reclamo" placeholder="Ingresar el celular" value="<?php echo !empty($reclamo) ? $reclamo->celular_reclamo : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group pb-3">
                                <label for="correo_reclamo">Correo</label>
                                <input type="email" class="form-control" id="correo_reclamo" name="correo_reclamo" placeholder="Ingresar el correo" value="<?php echo !empty($reclamo) ? $reclamo->correo_reclamo : ''; ?>" required>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <button type="submit" class="btn border-0 btn-info py-2 px-3 btn-sm rounded-pill saveBtn">Guardar
                            Información</button>
                        <a href="/admin/reclamos"
        ...
        init: function (){
            ...
            this.on("addedfile", function(file){
                ...
                setTimeout(function(){
                    ...
                    elem.parent().children(".galleryReclamo").val(JSON.stringify(arrayFiles));
...
<script>
    ...
    function loadGoogleMapsApi() {
        ...
        script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyAaRnCKVVSWGR159MyTF6rV7NMIPsW960c&libraries=places&callback=initialize";
        script.async = true;
...
.accordion-button:not(.collapsed) {
    background-color: #074A1F; /* Cambia a tu color deseado */
...
.accordion-button {
    font-weight: 700;
    background-color: #2E6B4E; /* Color de fondo predeterminado */
...
.accordion-button:hover {
    background-color: #074A1F; /* Cambia a tu color deseado al pasar el ratón */
